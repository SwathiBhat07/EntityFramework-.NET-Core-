...
namespace BulkyBookWeb.Controllers
{
    public class CategoriestempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DisplaySeq,Createddatetime")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DisplaySeq,Createddatetime")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
